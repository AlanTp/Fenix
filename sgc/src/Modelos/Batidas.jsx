...
function Batidas() {
    ...
    const totaisPorColaborador = batidas.reduce((acc, b) => {
        ...
        acc[b.colaborador].batida_normal += b.batida_normal || 0;
        acc[b.colaborador].batida_extra += b.batida_extra || 0;
        acc[b.colaborador].perdas += b.perdas || 0;
        acc[b.colaborador].amostra += b.amostra || 0;
            ...
            <Container fluid className={styles.containerFluid}>
                ...
                <div>
                    <table className={`table table-striped table-bordered ${styles.tableEqual}`}>
                        ...
                        <tr>
                            <th>Colaborador</th>
                            <th>Batidas Normais</th>
                            <th>Batidas Extras</th>
                            <th>Meta</th>
                            <th>Amostra</th>
                            <th>Perdas</th>
                            <th>Data</th>
